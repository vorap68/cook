				...
				<nav class="mnu mx-auto">
                    ...
                    <input type="checkbox" id="drop">
						<ul class="menu">
							...
							<li class="mt-sm-3"><a href="<?= Url::to('/admin/order/employee') ?>" class="scroll">Выбор блюд на сегодня:<?=date('Y-m-d')?></a></li>
							<li class="active"><a href="<?= Url::to('/admin/order/employeetoday')?>" class="scroll">Мой заказ</a></li>
